...
const Demos: FC = () => {
  ...
  return (
    <div className='mb-0'>
      <h3 className='fw-bolder text-center mb-6'>{window.__RUNTIME_CONFIG__.REACT_APP_THEME_NAME} Demos</h3>
          ...
          <div className='col-6' key={index}>
            <div
              className={`overlay overflow-hidden position-relative ${
                window.__RUNTIME_CONFIG__.REACT_APP_THEME_DEMO === item.name
            ...
            >
              ...
              <div className='overlay-layer bg-dark bg-opacity-10'>
                {item.available && (
                  <a
                    href={`${window.__RUNTIME_CONFIG__.REACT_APP_PREVIEW_REACT_URL}/${item.name}`}
