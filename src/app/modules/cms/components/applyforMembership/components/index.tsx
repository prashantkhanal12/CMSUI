...
import AddApplyforMembership from './AddApplyforMembership'
...
const applyforMembership = () => {
  ...
  useEffect(() => {
    if (deleteSuccess) {
      toast.success('Apply for Membership deleted successfully')
    }
  ...
  return (
    <>
      <div className='shadow p-3 bg-white rounded'>
        <DesignComponent
          moduleName='Apply for Membership'
          params={params}
          setParams={setParams}
