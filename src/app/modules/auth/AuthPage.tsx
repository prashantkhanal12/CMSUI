...
import {toAbsoluteUrl} from '../../../cms/helpers'
...
export function AuthPage() {
  ...
  // const getToken = useSelector<RootState>(({auth}) => auth.accessToken, shallowEqual)
  useEffect(() => {
  ...
  return (
    <>
      <div className='row g-0'>
        <div className='col-lg-8 col-md-12 p-0 position-relative'>
          <svg className='overlay-svg' xmlns='http://www.w3.org/2000/svg' width='100%'>
            <defs>
              <linearGradient
                id='a'
          ...
          <div
            ...
            style={
              {
                // background:
                //   "url(../media/patterns/subtle-prism.svg) no-repeat red",
          ...
          <div
            className='overlay-text text-center'
            style={{
              color: 'white',
            }}
          >
          ...
          <div className='login-wrapper'>
            <div className='login-box'>
              ...
              <div className='login-box-body'>
                <Switch>
                  <Route path='/auth/login/:id?' component={Login} />
                  <Route path='/auth/set-password/:id?' component={NewPassword} />
                  <Route path='/auth/forgot-password' component={ForgotPassword} />
                  <Route path='/auth/reset-password/:id' component={ResetPassword} />
                  {/* <Route path='/auth/verify-user' component={VerifyUser} /> */}
                  <Route path='/auth/success' component={EmailSuccess} />
                  <Route path='/auth/update-password/:id?' component={UpdatePassword} />
                  {/* {getToken && ( */}
